...
from model.anime_gan import Discriminator
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default=defaultArgs.dataset)
    parser.add_argument('--data-dir', type=str, default=defaultArgs.data_dir)
    parser.add_argument('--epochs', type=int, default=defaultArgs.epochs)
    parser.add_argument('--init-epochs', type=int, default=defaultArgs.init_epochs)
    parser.add_argument('--batch-size', type=int, default=defaultArgs.batch_size)
    parser.add_argument('--checkpoint-dir', type=str, default=defaultArgs.checkpoint_dir)
    parser.add_argument('--save-image-dir', type=str, default=defaultArgs.save_image_dir)
    parser.add_argument('--gan-loss', type=str, default=defaultArgs.gan_loss, help='lsgan / hinge / bce')
    parser.add_argument('--resume', type=str, default=defaultArgs.resume)
    parser.add_argument('--use_sn', action='store_true')
    parser.add_argument('--save-interval', type=int, default=defaultArgs.save_interval)
    parser.add_argument('--debug-samples', type=int, default=defaultArgs.debug_samples)
    parser.add_argument('--lr-g', type=float, default=defaultArgs.lr_d)
    parser.add_argument('--lr-d', type=float, default=defaultArgs.lr_g)
    parser.add_argument('--init-lr', type=float, default=1e-3)
    parser.add_argument('--wadvg', type=float, default=defaultArgs.wadvd, help='Adversarial loss weight for G')
    parser.add_argument('--wadvd', type=float, default=defaultArgs.wadvd, help='Adversarial loss weight for D')
    parser.add_argument('--wcon', type=float, default=defaultArgs.wcon, help='Content loss weight')
    parser.add_argument('--wgra', type=float, default=defaultArgs.wgra, help='Gram loss weight')
    parser.add_argument('--wcol', type=float, default=defaultArgs.wcol, help='Color loss weight')
